...
Public Declare Function IsEqualIID Lib "ole32" (riid1 As UUID, riid2 As UUID) As Long
...
Static iid As UUID
 If (iid.Data1 = 0) Then Call DEFINE_OLEGUID(IID_IContextMenu, &H214E4, 0, 0)
 IID_IContextMenu = iid
End Function
Public Function IID_IContextMenu2() As UUID
Static iid As UUID
 If (iid.Data1 = 0) Then Call DEFINE_OLEGUID(IID_IContextMenu2, &H214F4, 0, 0)
