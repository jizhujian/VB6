...
Begin VB.UserControl TPropertySheet 
   ...
   ClientTop       =   0
   ClientWidth     =   4572
   PropertyPages   =   "PropertySheet.ctx":0000
   ScaleHeight     =   2568
   ScaleWidth      =   4572
   ToolboxBitmap   =   "PropertySheet.ctx":002F
   Begin MSComctlLib.ImageList StdImages 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0341
            Key             =   "frame"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0453
            Key             =   "plus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":04C4
            Key             =   "dots"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":05BE
            Key             =   "drop"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":06B8
            Key             =   "check_off"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":07CA
            Key             =   "check_on"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":08DC
            Key             =   "minus"
         EndProperty
      EndProperty
   End
   Begin VB.ListBox lstCheck 
      Appearance      =   0  'Flat
      Height          =   24
      ItemData        =   "PropertySheet.ctx":094A
      Left            =   480
      List            =   "PropertySheet.ctx":0951
      Style           =   1  'Checkbox
      TabIndex        =   7
      Top             =   2112
      Width           =   972
   ...
   Begin VB.CommandButton cmdBrowse 
      Height          =   372
      Left            =   240
      Picture         =   "PropertySheet.ctx":0958
      Style           =   1  'Graphical
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   1080
   ...
   Begin MSComctlLib.ImageList StdImages2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   11
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0A42
            Key             =   "minus"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0AB0
            Key             =   "plus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0B21
            Key             =   "dots"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0C1B
            Key             =   "drop"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0D15
            Key             =   "check_on_sel"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0E27
            Key             =   "check_off_sel"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":0F39
            Key             =   "check_on_2"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":104B
            Key             =   "check_off_2"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":115D
            Key             =   "check_off"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":126F
            Key             =   "check_on"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheet.ctx":1381
            Key             =   "frame"
         EndProperty
      EndProperty
   End
...
Private m_ImageListAttached As Boolean
...
Public Property Get ImageList() As Object
    On Error GoTo Err_ImageList
    Const constSource As String = m_constClassName & ".ImageList"

    Set ImageList = Extender.Parent.Controls(m_ImageList)
    Exit Property
Err_ImageList:
    Set ImageList = Nothing
End Property

Public Property Set ImageList(ByRef vImageList As Variant)
    m_hIml = 0
    ...
    If (m_hIml <> 0) Then
        ...
        End If
    End If
'    If New_ImageList Is Nothing Then
'        m_ImageList = ""
'    Else
'        m_ImageList = New_ImageList.Name
'        Grid_ChangeImageList
'    End If
...
'        objCat.BackColor = m_CatBackColor
'    End If
'    If objCat.ForeColor = CLR_INVALID Then
'        objCat.ForeColor = m_CatForeColor
'    End If
    With fGrid
        ' add new category
...
'        objProp.BackColor = m_BackColor
'    End If
'    ' update fore color
'    If objProp.ForeColor = CLR_INVALID Then
'        objProp.ForeColor = m_ForeColor
'    End If
    ' update grid
    With fGrid
...
Private Sub Cell_DrawPicture( _
    ...
    End If
    Cell_DrawPictureEx Row, Col, Image, ImageList, BkColor
    Exit Sub
...
Private Sub DrawCheckBox( _
    ...
    End If
    Cell_DrawPictureEx Row, colValuePicture, Image, StdImages, BkColor
End Sub
...
Private Sub Cell_DrawPictureEx( _
       ...
       ImgList As MSComctlLib.ImageList, _
    ...
    If fGrid.RowHeight(Row) = 0 Or ImgList Is Nothing Then Exit Sub
    
    Dim varX As Variant
    On Error Resume Next
    
    Set varX = ImgList.ListImages(Image)
    ...
    With fGrid
        ...
        On Error Resume Next
        ImgList.BackColor = BkColor
        Set .CellPicture = ImgList.Overlay(Image, Image)
        .Redraw = True
    End With
