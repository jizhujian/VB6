...
Begin VB.UserControl TPropertySheet 
   ...
   ScaleHeight     =   2568
   ScaleWidth      =   4572
   ToolboxBitmap   =   "PropertySheetB.ctx":0000
   Begin MSComctlLib.ImageList StdImages 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0312
            Key             =   "frame"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0424
            Key             =   "plus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0495
            Key             =   "dots"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":058F
            Key             =   "drop"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0689
            Key             =   "check_off"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":079B
            Key             =   "check_on"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":08AD
            Key             =   "minus"
         EndProperty
      EndProperty
   End
   Begin VB.ListBox lstCheck 
      Appearance      =   0  'Flat
      Height          =   24
      ItemData        =   "PropertySheetB.ctx":091B
      Left            =   480
      List            =   "PropertySheetB.ctx":0922
      Style           =   1  'Checkbox
      TabIndex        =   7
      Top             =   2112
      Width           =   972
   ...
   Begin VB.CommandButton cmdBrowse 
      Height          =   372
      Left            =   240
      Picture         =   "PropertySheetB.ctx":0929
      Style           =   1  'Graphical
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   1080
   ...
   Begin MSComctlLib.ImageList StdImages2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   11
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0A13
            Key             =   "minus"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0A81
            Key             =   "plus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0AF2
            Key             =   "dots"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0BEC
            Key             =   "drop"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0CE6
            Key             =   "check_on_sel"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0DF8
            Key             =   "check_off_sel"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":0F0A
            Key             =   "check_on_2"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":101C
            Key             =   "check_off_2"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":112E
            Key             =   "check_off"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":1240
            Key             =   "check_on"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PropertySheetB.ctx":1352
            Key             =   "frame"
         EndProperty
      EndProperty
   End
...
'    DeHilite
    With fGrid
        ...
        If ObjCat.Selected Then
            tmpBackColor = m_SelBackColor
            tmpForecolor = m_SelForeColor
        Else
            If ObjCat.BackColor = CLR_INVALID Then
                tmpBackColor = m_CatBackColor
            Else
                tmpBackColor = ObjCat.BackColor
            End If
            If ObjCat.ForeColor = CLR_INVALID Then
                tmpForecolor = m_CatForeColor
            Else
                tmpForecolor = ObjCat.ForeColor
            End If
        End If
...
Friend Sub AddNewProperty(ByVal objProp As TProperty, ByVal Relative As TCategory)
...
'    DeHilite
    ...
    With fGrid
        ...
        If HasGraphicInterface(objProp) Then
            DrawGraphicInterface objProp, CurrRow
        End If
        ' sort column
        .Col = colOrderByCategory
        .Text = Index
...
'            End If
            ...
            End If
        End If
    ElseIf Col > colStatus And Col < colOrderByCategory Then
        strText = Pad(strText)
    End If
    ' write the cell
    With fGrid
...
Private Sub Grid_ShowCategories()
    ...
    If m_ShowCategories = False Then
        ...
        If fGrid.Rows > 0 Then
            For Row = 0 To fGrid.Rows - 1
                ...
                If LoWord(Val(fGrid.TextMatrix(Row, colOrderByCategory))) = 0 Then
    ...
    Else
        ...
        DoSort 0, fGrid.Rows - 1, colOrderByCategory, 1
        ...
        Do While Row < fGrid.Rows
            ...
            Else
                ...
                RowStart = Row
                Do While LoWord(fGrid.TextMatrix(Row, colOrderByCategory)) > 0
...
'            Cell_Write Row, ColPicture, m_Categories(i).Caption
'            Cell_Write Row, ColName, m_Categories(i).Caption
'            Cell_Write Row, colValuePicture, m_Categories(i).Caption
'            Cell_Write Row, colValue, m_Categories(i).Caption
'            For j = 1 To m_Categories(i).Properties.Count
'                Cell_Write Row, ColPicture, m_Categories(i).Properties(j).Caption
'                Cell_Write Row, ColName, m_Categories(i).Properties(j).Caption
'                Cell_Write Row, colValuePicture, m_Categories(i).Properties(j).Caption
...
Friend Sub TriggerEvent(ByVal RaisedEvent As String, ParamArray aParams())
    Select Case RaisedEvent
        ...
        Case "ValueChanged"
            Cell_ValueChanged aParams(0), aParams(1), aParams(2)
        Case "AddNewCategory"
...
Private Sub Cell_ValueChanged(ByVal Prop As TProperty, ByVal Row As Integer, ByVal NewValue As Variant)
...
Private Sub Cell_CaptionChanged(ByVal Prop As TProperty, ByVal Row As Integer, ByVal NewCaption As String)
    On Error GoTo Err_ValueChanged
    Const constSource As String = m_constClassName & ".ValueChanged"
    ...
    End If
    ' write the edit cell
    Cell_Write Row, ColName, NewCaption
    ' restore cell properties
    Cell_Restore Cell
    ' enable drawing
    'fgrid.Redraw = True
